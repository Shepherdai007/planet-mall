          ...
          <div className="px-4 pt-8 pb-6 max-w-2xl mx-auto">
            ...
            <div className="p-6 rounded-2xl mb-4" style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.06)"}}>
              ...
              <div className="flex gap-2 flex-wrap mb-4">
                ...
                {tipster.whatsapp  && <a href={tipster.whatsapp.startsWith("http") ? tipster.whatsapp : `https://wa.me/${tipster.whatsapp.replace(/[^\d]/g,"")}`} target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 rounded-full text-xs font-dm-sans font-semibold" style={{background:"rgba(37,211,102,0.15)",color:"#25D366"}}>💬 WhatsApp</a>}" className="px-3 py-1.5 rounded-full text-xs font-dm-sans font-semibold" style={{background:"rgba(37,211,102,0.15)",color:"#25D366"}}>💬 WhatsApp</a>}
